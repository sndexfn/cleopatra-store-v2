      ...
      try {
        ...
        if (data && data.length > 0) {
          ...
          setSiteStats({
            ...
            karatLabel: get('stats_karat_label', 'اعيار الذهب (21)'),
    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.stats}>
          ...
          <div className={styles.statDivider} />
          <div className={styles.statItem}><span className={styles.statNum}>{siteStats.karat}</span><span className={styles.statLabel}>{siteStats.karatLabel || (lang === 'ar' ? 'اعيار الذهب (21)' : 'Gold Karat (21)')}</span></div>
        </section>
